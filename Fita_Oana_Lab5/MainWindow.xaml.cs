...
namespace Fita_Oana_Lab5
{
    ...
    public partial class MainWindow : Window
    {
        ...
        {
            Fita_Oana_Lab5.PhoneNumbersDataSet phoneNumbersDataSet = ((Fita_Oana_Lab5.PhoneNumbersDataSet)(this.FindResource("phoneNumbersDataSet")));
